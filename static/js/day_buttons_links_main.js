    $(document).ready(function () {
        ...
        $('.btn_to_click').click(function (e) {
            ...
            if (selected_year!="non_year" && selected_month!="non_month" && selected_day!="non_day"){
                ...
                var selected_lang = $("#select_lang option:selected").val();
                var url_default;
                switch (selected_lang){
                    case 'non_lang':
                        url_default = $('#url_day').attr('data-sj');
                        break;
                    case 'ara':
                        url_default = $('#url_day_ara').attr('data-sj');
                        break;
                    case 'chi':
                        url_default = $('#url_day_chi').attr('data-sj');
                        break;
                    case 'eng':
                        url_default = $('#url_day_eng').attr('data-sj');
                        break;
                    case 'por':
                        url_default = $('#url_day_por').attr('data-sj');
                        break;
                    case 'spa':
                        url_default = $('#url_day_spa').attr('data-sj');
                        break;
                    default:
                        url_default = $('#url_day').attr('data-sj');
                        break;
                }
                var link_text = url_default + "?by=" + by + "&bm=" + bm + "&bd=" + bd + "&ty=" + ty + "&tm=" + tm + "&td=" + td;
